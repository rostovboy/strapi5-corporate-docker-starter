...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    noThumb: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    photoCarousel: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    photoGallery: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uri: Schema.Attribute.String & Schema.Attribute.Unique;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    inPrice: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    introtext: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    seo: Schema.Attribute.Component<'shared.seo-data', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tds: Schema.Attribute.Media<'images'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mainEmail: Schema.Attribute.String;
    mainPhone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    requisites: Schema.Attribute.Text;
